...
* Make sure we understand how to run your program. Add RUN.md file that describes how to start it.
* We will run a formal code review on your solution. Makre sure your code is not only correct but also easy to read and reason about.
* You can use external libraries but you should only use the tools that are right to do the job. You don't have to build UI or implement database access to get the job done. Showcasing how many libraries of frameworks you know is not the goal of the task.
